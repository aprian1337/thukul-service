...
func (_m *Usecase) Create(ctx context.Context, domain wallets.Domain) error {
...
func (_m *Usecase) GetByUserId(ctx context.Context, userId int) (wallets.Domain, error) {
...
func (_m *Usecase) UpdateByUserId(ctx context.Context, domain wallets.Domain) (wallets.Domain, error) {
	ret := _m.Called(ctx, domain)
